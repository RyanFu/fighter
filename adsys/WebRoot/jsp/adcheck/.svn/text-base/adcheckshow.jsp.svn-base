  ...
  <head>
	...
	<script type="text/javascript">
		...
		function pageselectCallback(page_index, jq){
            ...
            {
                newcontent += '<tr>'
                newcontent += '<td>' + data[i].name + '</td>';
                newcontent += '<td>' + data[i].img_word_type + '</td>';
                newcontent += '<td>' + data[i].title + '</td>';
                newcontent += '<td>' + data[i].state + '</td>';
                
                newcontent += '<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=basePath%>ctrl/getAdPutWays.man?adId='+ data[i].id+'">审批</a></td>';
                newcontent += '</tr>'
            }
  	...
  	<div id="head">
		...
		<div id="content">
		    ...
		    <div style="float:left;margin-top:60px;margin-left:20px;width:700px;background:white;
		    	...
		    	<h2 style="margin-top:20px;margin-left:20px">广告审批</h2>
