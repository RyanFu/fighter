  	...
  	<div id="head">
		...
		<div id="content">
		    ...
		    <div style="float:left;margin-top:80px;margin-left:20px;width:700px;background:white;border-style:solid;border-width:1px;border-color:gray;font-family:Arial, Helvetica, sans-serif;font-size:12px">
		    	...
		    	<form action="<%=basePath%>ctrl/rechargeAccountInfoUpdate.man" method="post" id="finanForm">
		    	<input type="hidden" name="rechAccId"  value="${rechId}">
			    <table id="ad" align="center" style="margin-top:80px" id="finanForm">
			    	...
			    	<tr>
			    		<td>开户银行：</td>
			    		<td><input type="text" name="bank_name" id="finanOpenB" value="${bank_name}"></td>
			    	</tr>
			    	<tr>
			    		<td>账号：</td>
			    		<td><input type="text" name="bank_num" id="finanAccountN" value="${bank_num}"></td>
			    	</tr>
			    	<tr>
			    		<td>开户名称：</td>
			    		<td><input type="text" name="open_name" id="finanOpenName" value="${open_name}"></td>
			    	</tr>
			    	<tr>
			    		<td>银行地址：</td>
			    		<td><input type="text" name="bank_address" id="finanAddressB" value="${bank_address}"></td>
			    	</tr>
			    	
			    </table>
			         <tr>
			    		<td>&nbsp;</td>
			    		<td><button type="button" id="finanSubmit" style="margin-left:285px;margin-top:20px;margin-bottom:20px">保存</button><button type="button" id="goback" style="margin-left:20px;margin-top:20px;margin-bottom:20px">返回</button></td>
			    	</tr>
			    </form>
		    </div>
		</div>
