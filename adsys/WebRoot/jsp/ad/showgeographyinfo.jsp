  ...
  <head>
	...
	<script type="text/javascript">
		...
		function pageselectCallback(page_index, jq){
            ...
            {
                newcontent += '<tr>'
                //newcontent += '<td>' + codeToZone(data[i].geography) + '</td>';
                newcontent += '<td>' + parseProvinceCode(data[i].geography) + '</td>';
        ...
        /*function codeToZone(code) {
        	switch (code) {
        	case '110000' : return '北京';
        	case '120000' : return '上海';
        	case '130000' : return '上海';
        	case '140000' : return '上海';
        	case '150000' : return '上海';
        	case '210000' : return '上海';
        	case '220000' : return '上海';
        	case '120000' : return '上海';
        	case '120000' : return '上海';
        	}
        }*/
  	...
  	<div>
		...
		<div id="content" style="margin: 0 auto;width:972px;white-space:nowrap;">
		    ...
		    <div class="Border" style="width:720px">
		    	...
		    	<input type="hidden" id="statInfo" value='${adStatisticsByGeography}'>
		    	<table id="adstattbl">
		    		<thead>
		    			<tr>
		    				<th>地区</th>
