...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#f93","bg_over":"#EFEFEF","bg_out":"#6d90ca"}
};
...
cis[cis.length] ='td.sat {color:#eb6100;background-color:#EFEFEF;}';
cis[cis.length] ='td.sun {color:#eb6100;background-color:#EFEFEF;}';
