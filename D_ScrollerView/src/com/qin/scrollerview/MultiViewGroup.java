   ...
   //startScroll 滑屏
	...
	public boolean onTouchEvent(MotionEvent event){
		...
		if (mVelocityTracker == null) {
			...
			Log.d(TAG, "onTouchEvent start-------** VelocityTracker.obtain");
		...
		case MotionEvent.ACTION_MOVE:
			...
			Log.d(TAG, "--- MotionEvent.ACTION_MOVE--> detaX is " + detaX );
			mLastionMotionX = x ;
	...
	private void snapToDestination(){
		...
		Log.d(TAG, "### onTouchEvent snapToDestination ### scrollX is " + scrollX);
	    ...
	    Log.d(TAG, "### onTouchEvent  ACTION_UP### dx destScreen " + destScreen);
    ...
    private void snapToScreen(int whichScreen){	
	    ...
	    Log.d(TAG, "### onTouchEvent  ACTION_UP### dx is " + dx);
